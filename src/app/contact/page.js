  ...
  return (
    <div className="bg-purple-200 min-h-screen flex flex-col">
      ...
      <form
        ...
        className="max-w-xl mx-auto p-6 bg-white shadow-md mb-[50px] rounded-md space-y-4"
      >
        ...
        <div>
          <input
            ...
            required
            className="mt-1 block w-full p-[10px] rounded-2xl border-gray-300 shadow-md focus:shadow-lg shadow-purple-500 focus:border-purple-500 focus:ring focus:ring-purple-200 focus:outline-none"
          />
        </div>
